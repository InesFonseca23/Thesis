...
# Dijkstra: finding the shortest paths between nodes in a weighted graph
...
def calculate_distances(net):
    ...
    # Connections between switches and hosts
    ...
    # Calculate minimum distances using Dijkstra's algorithm
    for node_id in graph.keys():
        distances[node_id] = dijkstra(graph, node_id)

    # Remove non-host distances
...
def find_max_distance_hosts(net): 
...
def find_info_P(net, max_distance_hosts):
