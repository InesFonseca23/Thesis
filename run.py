...
# checks if openvswitch is functional
...
if __name__ == "__main__":
    ...
    parser.add_argument('-cn', '--controller_name', choices=['onos', 'ryu', 'odl'], required=True, help='Controller name') # Só testei c/ ONOS mas futuramente usar o for
